...
@include "../Quiz Checker/checker_v1.4.awk"
...
BEGIN {
  ...
  SELECT_cols[0] = "food.name";
  SELECT_cols[1] = "food.country";
  SELECT_cols[2] = "restaurants.restaurant";
  SELECT_cols[3] = "nutrition.calories";

  # Defines array containing all required tables to join (e.g. FROM <table0> JOIN <table1> ... JOIN <table2>).
  FROM_tables[0] = "restaurants";
  FROM_tables[1] = "nutrition";
  FROM_tables[2] = "food";
  ...
  ON_cols[0] = "restaurants.country";
  ON_cols[1] = "food.country";
  ON_cols[2] = "food.name";
  ON_cols[3] = "nutrition.name";
