...
switch (code){
	...
	case "01-037":
		return "The structure of an insert is: 'INSERT INTO <table> ...'. Make sure INTO follows INSERT in your query.";
	case "01-038":
	...
	case "02-010":
		return "Think about adding a VALUES statement to your query: 'INSERT INTO table (col1, col2,...) VALUES (val1, val2,...)'.";
	case "02-011":
